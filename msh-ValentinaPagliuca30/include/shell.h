...
/*
* builtin_cmd -checks whether the given argv represents a built-in command
*
* argv - an array of arguments produced from the user's command line.
*
* Returns: a pointer to a command line string only in the special case of the !N
* history command, indicating that evaluate() should run that line again.
*/
